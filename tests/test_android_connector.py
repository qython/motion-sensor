...
EXPECTED_URL_TO_SENSOR_DATA = urltools.normalize("http://192.168.0.13:8080/sensors.json?sense=motion")
EXPECTED_URL_TO_PHOTO = urltools.normalize("http://192.168.0.13:8080/shot.jpg")
EXPECTED_TMP_PHOTO_FILE_LOCATION = os.path.normpath("tmp/last_photo.jpg")
